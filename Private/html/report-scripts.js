...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function getScoreColor(score) {
        ...
        if (savePdfBtn && window.html2canvas && window.jspdf) {
            savePdfBtn.addEventListener('click', () => {
                ...
                // Render body to canvas and save as PDF
                setTimeout(() => {
...
function paginateNodeCards(container, paginationContainer, itemsPerPage = 5) {
    const cards = Array.from(container.querySelectorAll('.collapsible-container'));

	...
	return []directRiskPathDefinition{
		{
			...
			Signals:            []string{"POD011", "POD013", "SEC002", "SEC004", "SEC010", "SEC012", "SEC017", "SEC021", "SEC023", "SEC029", "SEC038"},
			TriggerThreshold:   2,
			CriticalSingleHits: idSet([]string{"SEC004", "SEC010", "SEC012", "SEC029", "SEC038"}),
		...
		},
		{
			...
			Signals:            []string{"NET004", "NET021", "NET023", "NET024", "RBAC002", "RBAC007", "RBAC008", "RBAC010"},
			TriggerThreshold:   2,
			CriticalSingleHits: idSet([]string{"NET024", "RBAC002", "RBAC007", "RBAC010"}),
		...
		},
		{
			...
			Signals:            []string{"POD008", "SEC015", "SEC018", "SEC040", "RBAC009", "RBAC010"},
			TriggerThreshold:   2,
